<template>
  <el-container>
    ...
    <el-header class="header">
      ...
      <!-- Independent icon and its associated popover -->
      <el-popover
        :width="800"
        trigger="click"
      ...
      <el-button @click="logout" type="text" class="logout-button header-text">
        Logout
      </el-button>
...
<!---->
<el-menu-item index="1-1" @click="loadDataList" >
...
<el-menu-item index="1-2" @click="VideoloadDataList">
  <span class="menu-item-content">
...
<el-menu-item index="1-3" @click="MusicloadDataList">
  <span class="menu-item-content">
...
<el-menu-item index="1-4" @click="PictureloadDataList">
  <span class="menu-item-content">
...
<el-menu-item index="1-5" @click="DocloadDataList">
  <span class="menu-item-content">
...
<el-menu-item index="1-6" @click="OtherloadDataList">
  <span class="menu-item-content">
...
const PictureloadDataList = async () => {
  let params = {
    pageNo: tableData.value.pageNo,
    pageSize: tableData.value.pageSize,
    category: "image" ,
...
const size2Str = (limit) => {
  ...
  var sizeStr = size + ""; // Convert to a string
  var index = sizeStr.indexOf("."); // Get the index of the decimal point
  var dou = sizeStr.substr(index + 1, 2); // Get the value after the decimal point
  if (dou === "00") { // Check if the next two digits are 00; if so, remove them
...
// Multiple Selection - Batch Selection
